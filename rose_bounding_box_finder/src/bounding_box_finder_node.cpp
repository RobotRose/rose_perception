...
// Set up ROS.
  ...
  //dynamic_reconfigure::Server<bounding_box_finder::bounding_box_finderConfig> server_;
  //dynamic_reconfigure::Server<bounding_box_finder::bounding_box_finderConfig>::CallbackType f;
